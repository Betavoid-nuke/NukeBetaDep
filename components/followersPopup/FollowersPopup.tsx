...
export async function FollowerPopover({userImage,followers,cuserid}:props) {
    ...
    for (let i = 0; i < followers.length; i++) {
        for (let o = 0; o < response.users.length; o++) {
            if (followers[i].toString() === response.users[o]._id.toString()) {
    ...
    return (
      <Dialog>
        ...
        <DialogContent className="sm:max-w-[425px]" style={{backgroundColor:'#09090b', borderColor:'#1f1f1f', border:'solid', borderWidth:'1px'}}>
            ...
            <DialogHeader>
              <DialogTitle className="text-light-1">Followers</DialogTitle>
            </DialogHeader>
